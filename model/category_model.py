...
class CategoryModel:
    ...
    def load_model_and_vectorizer(self):
        self.model = joblib.load("model/models/news_category_model.pkl")
        self.vectorizer = joblib.load("model/models/vectorizer.pkl")
        self.label_encoder = joblib.load("model/models/label_encoder.pkl")
